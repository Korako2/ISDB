...
VALUES ('Иван', 'Иванов', 'Иванович', 'M', '1990-10-25'),
...
VALUES (4, '1234567890', '1234 5678 9012 3456'),
...
VALUES (1, 800, 30000, '2023-10-25', 1),
...
VALUES (900.0, 1.0, 1.9, 4.0, 1, 'BULK'),
       (800.0, 1.9, 1.7, 3.5, 2, 'TIPPER'),
       (700.0, 1.8, 1.8, 3.5, 3, 'BULK');

TRUNCATE TABLE loading_unloading_agreement CASCADE;
INSERT INTO loading_unloading_agreement (order_id, driver_id, departure_point, delivery_point, sender_id, receiver_id,
                                         unloading_time, loading_time)
VALUES (1, 1, 1, 2, 1, 2, '08:00', '16:00'),
...
VALUES (1, '1990-01-01', '2040-01-01', 1234542),
...
VALUES (1, '2023-10-25 00:00:00', 'ACCEPTED_ORDER'),
       (1, '2023-10-25 00:00:02', 'ARRIVED_AT_LOADING_LOCATION'),
       (1, '2023-10-25 00:00:03', 'LOADING'),
       (1, '2023-10-25 00:00:05', 'EN_ROUTE'),
       (1, '2023-10-25 00:00:06', 'ARRIVED_AT_UNLOADING_LOCATION'),
       (1, '2023-10-25 00:00:07', 'UNLOADING'),
       (1, '2023-10-25 00:00:08', 'COMPLETED_ORDER'),
       (1, '2023-10-25 00:00:01', 'OFF_DUTY'),
       (2, '2023-10-25 00:00:10', 'ACCEPTED_ORDER'),
       (2, '2023-10-25 00:00:11', 'ARRIVED_AT_LOADING_LOCATION'),
       (2, '2023-10-25 00:00:12', 'LOADING'),
       (2, '2023-10-25 00:00:14', 'EN_ROUTE'),
       (2, '2023-10-25 00:00:15', 'ARRIVED_AT_UNLOADING_LOCATION'),
       (2, '2023-10-25 00:00:16', 'UNLOADING'),
       (2, '2023-10-25 00:00:17', 'COMPLETED_ORDER'),
       (2, '2023-10-25 00:00:18', 'WEEKEND'),
       (2, '2023-10-25 00:00:19', 'READY_FOR_NEW_ORDER');
